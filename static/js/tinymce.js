//document.domain = 'sanimedicaltourism.com';
...
if (typeof tinyMCE != 'undefined') {
    ...
    tinyMCE.init({
        ...
        plugins : "syntaxhl,advimagescale,autolink,lists,spellchecker,pagebreak,style,layer,table,save,advhr,advimage,advlink,emotions,iespell,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template",
